...
class Datapreprocess:
    ...
    def __init__(self, data):
        self.data                  = data
        self.adjacency_substituted = self.load_matricies(self.data)
        
    def get_processed_data(self):
        return self.adjacency_substituted
    ...
    def load_matricies(self, data):
        ...
        adjacency_substituted                           = substitute_vocabulary(adjacency_substituted, token_dictionary)
